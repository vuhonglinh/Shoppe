    ...
    setExtendedPurchases((prev) => {
      ...
      return (
        purchaseInCart?.map((purchase) => {
          const isChoosenPurchasedFromLocation = purchaseId == purchase._id
          return {
            ...purchase,
            disabled: false,
            checked: isChoosenPurchasedFromLocation || Boolean(extendedPurchasesObject[purchase._id]?.checked)
          }
        }) || []
      )
    })
  }, [purchaseId, purchaseInCart])
      ...
      <div className='container'>
        {extendedPurchases.length > 0 ? (
          ...
          <div className='text-center'>
            ...
            <div className='mt-3 capitalize text-center'>Giỏ hàng của bạn còn trống</div>
            <div className='text-center mt-5'>
              <Link to={path.home} className=' bg-orange text-white px-8 py-2 hover:bg-orange/80 transition-all'>
                MUA NGAY
              </Link>
            </div>
          </div>
