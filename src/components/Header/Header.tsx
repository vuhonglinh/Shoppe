...
import image from 'src/assets/image/9bdd8040b334d31946f4.png'
      ...
      <div className='container'>
            ...
            renderPopover={
              <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                <div className='flex flex-col py-2 px-3 pr-32 pl-3'>
                  <button className='py-2 px-3 hover:text-orange text-black mt-2  text-left' onClick={() => changeLanguage('vi')} >Tiếng Việt</button>
                  <button className='py-2 px-3 hover:text-orange text-black mt-2  text-left' onClick={() => changeLanguage('en')}>English</button>
                </div>
              </div>
            }
          >
            ...
            <Popover
              ...
              renderPopover={
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                  ...
                  <Link to={path.HistoryPurchase} className='block py-3 px-4 hover:bg-slate-100 bg-white hover:text-cyan-500'>
                    Đơn mua
                  </Link>
                  <button
        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          <Link to={path.home} className='col-span-2'>
            <svg viewBox='0 0 192 65' className='fill-white h-11 w-full'>
              <g fillRule='evenodd'>
                ...
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200 max-w-[400px] text-sm'>
                  {purchaseInCart && purchaseInCart?.length > 0 ? (
                    <div className='p-2'>
                      ...
                      <div className='mt-5'>
                        {purchaseInCart.slice(0, MAX_PURCHASES).map((purchase, index) => (
                          <div className='mt-2 flex p-2 hover:bg-gray-100' key={index}>
                            <div className='flex-shrink-0'>
                              <img className='w-11 h-11 object-cover' src={purchase.product.image} alt='anh' />
                            </div>
                            <div className='flex-grow ml-2 overflow-hidden '>
                      ...
                      <div className='flex mt-6 items-center justify-between'>
                        <div className='capitalize text-xs text-gray-500'>
                          {purchaseInCart.length > MAX_PURCHASES ? MAX_PURCHASES - purchaseInCart.length : ''} Thêm vào
                          giỏ hàng
                        </div>
                        <Link
                          to={path.cart}
                    ...
                    <div className='flex h-[300px] w-[400px] flex-col items-center justify-center p-2'>
                      <img src={image} alt='no purchases' className='h-24 w-24' />
                      <div className='mt-3 capitalize text-center'>Chưa có sản phẩm</div>
                    </div>
                  )}
                </div>
              }
            >
              <div className='col-span-1 justify-content relative'>
                <div className=''>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                  ...
                  {purchaseInCart && purchaseInCart?.length > 0 && (
                    <span className='absolute top-[-5px] left-[20px] rounded-full px-[9px] py-[1px] bg-white text-sm text-orange'>
