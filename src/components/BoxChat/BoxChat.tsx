import { faAngleRight, faAnglesRight, faHeadset, faMagnifyingGlass } from "@fortawesome/free-solid-svg-icons";
...
export default function BoxChat() {
  ...
  return (
    <div>
      <button ref={refs.setReference} {...getReferenceProps()} className="h-[48px] w-[100px] bg-orange fixed z-50 right-[8px] bottom-0 rounded-lg flex items-center justify-center gap-2">
                  ...
                  <div className="p-1">
                    <div className="relative mt-2 rounded-md shadow-sm">
                      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                        <span className="text-gray-500 sm:text-sm"><FontAwesomeIcon icon={faMagnifyingGlass} size="sm" style={{ color: "#b3bccc", }} /></span>
                      </div>
